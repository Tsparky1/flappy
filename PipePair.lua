...
local GAP_HEIGHT = math.random(70, 120)
    ...
    self.x = VIRTUAL_WIDTH + math.random(32, 72)
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + GAP_HEIGHT + math.random(60) - math.random(20))
    }
